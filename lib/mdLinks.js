...
const mdLinks = (path, options) => {
  ...
  return new Promise(resolve => {
    if (!options.validate) {
      resolve((0, _links.extractLinks)((0, _path.readDirectoryOrFile)(pathAbsolute)));
    }

    if (options.validate) {
      resolve((0, _validate.validateLinks)((0, _links.extractLinks)((0, _path.readDirectoryOrFile)(pathAbsolute))));
    }
  });
